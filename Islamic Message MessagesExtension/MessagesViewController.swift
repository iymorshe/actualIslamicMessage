...
//
//  Created by Tushar Nandwani on 8/20/23.
//
...
class MessagesViewController: MSMessagesAppViewController {
    ...
    override func viewDidLoad() {
        ...
        let child = UIHostingController(rootView: IslamicView(viewSize: presentationStyle, activeSession: activeConversation))
    ...
    override func didTransition(to presentationStyle: MSMessagesAppPresentationStyle) {
        ...
        let child = UIHostingController(rootView: IslamicView(viewSize: presentationStyle, activeSession: self.activeConversation))
...
/*
 //
 //  MessagesViewController.swift
 //  TogetherToDo MessagesExtension
 //
 //  Created by Jan Kammerath on 18.11.23.
 //
 ...
 class MessagesViewController: MSMessagesAppViewController {
     ...
     override func viewDidLoad() {
         ...
         self.messageView = MessageView(
             ...
             onCreateToDoList: self.createToDoList,
             onUpdateToDoList: self.updateToDoList,
             isTranscriptPresentation: presentationStyle == .transcript
         )
