...
#ifndef ISLAMIC_MESSAGE_SWIFT_H
#define ISLAMIC_MESSAGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Islamic_Message",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Islamic_Message22MessagesViewController")
